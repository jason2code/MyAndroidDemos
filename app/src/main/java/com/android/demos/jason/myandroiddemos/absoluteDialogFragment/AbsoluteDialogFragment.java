...
public class AbsoluteDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_TITLE, R.style.NoTitleBar);
    ...
    public void windowDeploy(Dialog dialog) {
        ...
        window.setWindowAnimations(getArguments().containsKey(ARG_ANIMATION) ? getArguments().getInt(ARG_ANIMATION) : R.style.hotelplus_contacts_push_top); // 设置窗口弹出动画
